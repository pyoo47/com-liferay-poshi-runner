...
* [Code Blocks](#code-blocks)
	...
	+ [Control Flow Blocks](#control-flow-blocks)
		- [`if`, `else if`, and `else` conditional blocks](#if-else-if-and-else-conditional-blocks)
		- [`while` loop blocks](#while-loop-blocks)
		- [`for` loop blocks](#for-loop-blocks)
...
* [Code Statements](#code-statements)
	+ [Invocations](#invocations)
		...
		- [Java Method Invocations](#java-method-invocations)
		- [Utility Invocations](#utility-invocations)
			* [`echo` invocations](#echo-invocations)
			* [`fail` invocations](#fail-invocations)
			* [~~`takeScreenshot` invocations~~](#takescreenshot-invocations)
	+ [Assignments](#assignments)
		- [`var` assignments](#var-assignments)
			...
			* [Assigning `var`'s to class/method invocations](#assigning-vars-to-class-method-invocations)
